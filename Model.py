...
class Model:
    ...
    def _build_model(self):
       ...
       # ------------------ build evaluate_net ------------------
        ...
        self.private_act_model.add(Conv3D(32, (2, 3, 3), strides=(
            1, 2, 2), input_shape=self.input_shape, name='conv1'))
        self.private_act_model.add(Activation('relu'))
        self.private_act_model.add(Conv3D(48, (2, 3, 3), strides=(
            1, 1, 1), input_shape=self.input_shape, name='conv2'))
        self.private_act_model.add(Activation('relu'))
        self.private_act_model.add(Conv3D(64, (2, 3, 3), strides=(
            1, 1, 1), input_shape=self.input_shape, name='conv3'))
        self.private_act_model.add(Activation('relu'))
        ...
        self.private_act_model.add(
            Dense(self.act_dim, name="d1"))        # action model
        ...
        self.private_move_model.add(Conv3D(32, (2, 3, 3), strides=(
            1, 2, 2), input_shape=self.input_shape, name='conv1'))
        self.private_move_model.add(Activation('relu'))
        self.private_move_model.add(Conv3D(48, (2, 3, 3), strides=(
            1, 1, 1), input_shape=self.input_shape, name='conv2'))
        self.private_move_model.add(Activation('relu'))
        ...
        self.private_move_model.add(
            self.build_resblock(96, 2, name='Resnet_2', stride=2))
